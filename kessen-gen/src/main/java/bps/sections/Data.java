package bps.sections;

import bps.actions.*;
import bps.utils.Utils;
...
import static bps.actions.ActionType.SOURCE_COPY;
import static bps.actions.ActionType.TARGET_READ;
        ...
        while (offset<patchData.length-12) {
            ...
            switch (Utils.getActionType(read)) {
                ...
                case TARGET_READ:
                    ...
                    break;
                case SOURCE_COPY:
                    CopyAction sourceCopyAction = new CopyAction(SOURCE_COPY, Utils.getLength(read));
